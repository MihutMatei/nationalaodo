...
public class auto_redext extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory f1 = drive.trajectoryBuilder(startPose)
                ...
                .lineToSplineHeading(new Pose2d(25,-22,Math.toRadians(-16)))

                .build();


        Trajectory duck = drive.trajectoryBuilder(f1.end())
//                .lineToSplineHeading(new Pose2d(0.5,24,Math.toRadians(45)))
                .lineToSplineHeading(new Pose2d(1.5,22,Math.toRadians(45)))
        ...
        Trajectory parked =drive.trajectoryBuilder(duck.end())
                .lineToSplineHeading(new Pose2d(25,27,Math.toRadians(-90)))
                .build();
